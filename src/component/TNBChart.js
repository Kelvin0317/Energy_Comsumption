...
class TNBChart extends Component {
      ...
      <div className="chart">
        ...
        options = {{
          plugins: {
            title: {
                display: true,
                text: "Utility-TNB (Power) In Months"
            }
        },
        ...
        <Bar
          data = {{datasets: [{
            type: 'bar',
            label: '"Utility-TNB (Power) In Months',
        ...
        options = {{
          plugins: {
            title: {
                display: true,
                text: "Utility-TNB (Power) In " + this.state.whichDay
            }
        },
          scales: {y: { title: { display: true, text: 'Power Demand (kW)' }}}
        } 
